...
<html lang="en">
    ...
    <head>
        ...
        <title>AUL || Upload Documentation</title>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="page-title">Upload Documentation</h4>
                                    <ol class="breadcrumb">
                            ...
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Upload Documentation</h4>
                                        <p class="text-muted mb-4">Enter the URL of your Documentation</p>
                                        <style>
                                        .pad{
